  ...
  return (
    <form onSubmit={handleAddProductImages}>
      <div
        ...
        onDrop={handleDrop}
        className={`flex min-h-40 min-w-full justify-center rounded-lg border border-dashed border-pink-500 bg-pink-50/50 p-5 sm:w-sm dark:border-indigo-500 dark:bg-indigo-950/20 ${isSubmitting || (removedImages && removedImages.length > 0) ? "cursor-not-allowed opacity-50" : ""}`}
      >
