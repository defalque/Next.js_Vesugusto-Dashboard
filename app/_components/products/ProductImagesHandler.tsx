            ...
            {product.image.map((img, index) => (
              ...
              >
                <SafeImage
                  ...
                  className={`dark:shadow-primary-dark-700 object-cover transition-opacity duration-200 dark:shadow-sm dark:brightness-80 ${imagesToRemove.includes(img) ? "opacity-70" : ""}`}
                />
                <m.div
            ...
            <AnimatePresence mode="wait" initial={false}>
              {imagesToRemove.length > 0 && (
                <m.div
                  ...
                  className="fixed inset-x-4 bottom-4 z-10 mx-auto h-15 max-w-48 overflow-hidden rounded-xl border border-gray-200 bg-white shadow-2xs outline-none md:mx-auto md:w-full dark:border-zinc-800/50 dark:bg-zinc-950"
                >
