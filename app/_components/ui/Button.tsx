...
const variation = {
  base: "text-brand-50 dark:border-brand-dark-200 focus-visible:dark:ring-brand-950 focus-visible:ring-brand-dark-300 bg-brand-950 hover:bg-brand-900 dark:hover:bg-brand-dark-400 disabled:bg-brand-900 dark:bg-brand-dark-600 block cursor-pointer rounded-sm py-1 font-semibold transition-colors duration-300 text-shadow-md/10 focus-visible:ring-4 focus-visible:outline-none disabled:dark:bg-brand-950/15 disabled:dark:border-brand-950/15 disabled:cursor-not-allowed dark:border",
