      ...
      {pageCount > 1 && (
        <div className="flex gap-2">
          {currentPage !== 1 && (
            <button
              type="button"
              className="bg-brand-950 hover:bg-brand-900 flex cursor-pointer items-center rounded-lg px-4 py-2 font-semibold text-white shadow-sm transition-colors duration-300 dark:bg-zinc-700/80 dark:hover:bg-zinc-600/90"
              onClick={prevPage}
            >
              Indietro
            </button>
