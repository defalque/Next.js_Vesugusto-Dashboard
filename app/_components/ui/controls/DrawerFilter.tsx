        ...
        {options.map((option) => (
          <li key={option.value}>
            <button
              ...
              className={`${activeStatusFilter === option.value && "bg-brand-950/10 dark:bg-zinc-950"} hover:bg-brand-950/10 flex w-full cursor-pointer justify-between rounded-md px-2 py-3 dark:hover:bg-zinc-950`}
            >
              {option.label}
