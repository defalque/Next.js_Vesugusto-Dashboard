    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative">
        <input
          ...
          className="bg-style w-full rounded-md border border-gray-300 px-2.5 py-1.5 text-base placeholder:text-sm focus:border-zinc-400 focus:ring-2 focus:ring-gray-300 focus:outline-none disabled:animate-pulse disabled:cursor-not-allowed disabled:opacity-25 dark:border-zinc-700 dark:placeholder:text-zinc-600 dark:focus:border-zinc-400 dark:focus:ring-zinc-600"
